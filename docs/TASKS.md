...
| P3-A：Agent Card + Memory Spine | in_progress | P3-A-1 schema bridge complete; P3-A-2a Flutter local draft role-policy editor and P3-A-2b RolePolicy asset registry complete; P3-A-2c and P3-A-3 memory packet remain planned |
