...
| P3-A：Agent Card + Memory Spine | in_progress | P3-A-1 schema bridge complete; P3-A-2a Flutter local draft role-policy editor, P3-A-2b RolePolicy asset registry, P3-A-2c `prompt_v5` runtime consumption, and P3-A-3 AgentContextPacket memory schema complete; P3-A-4 first playable roleplay arm remains next |
