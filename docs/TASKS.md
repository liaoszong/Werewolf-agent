...
| P3-A：Agent Card + Memory Spine | in_progress | P3-A-1 schema bridge complete; P3-A-2a Flutter local draft role-policy editor complete; P3-A-2b/2c and P3-A-3 memory packet remain planned |
...
| P3-A-2：Mobile RolePolicy editor | in_progress | `docs/superpowers/specs/2026-07-05-p3-a-2-mobile-role-policy-editor-design.md`; P3-A-2a complete in Flutter local draft mode: RolePolicyPack-scoped two-column role grid, full-screen detail page, structured presets/settings, local dirty draft state, and read-only engine/runtime composition boundaries. P3-A-2b minimal asset registry and P3-A-2c runtime consumption remain pending |
