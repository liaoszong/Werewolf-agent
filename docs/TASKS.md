...
| P3-E-2：Mobile-first live room slice | in_progress | `clients/flutter_app/lib/src/screens/home_shell.dart`, `clients/flutter_app/test/widget/home_shell_test.dart`; first slice: mobile bottom nav, Home-owned match entry, role library, history grouping shell, Settings providers placeholder |
